...
function FormularioCadastro() {
    ...
    const cadastrarUsuario = async () => {
        try {
            const response = await axios.post('https://luffy-mugiwara-backend.onrender.com/jogadores', {nome, sexo, idade, altura, peso, posicao, numeroCamisa})
    ...
    return (
        <div className="container-formulario">
            <div className="container-esq">
                <img className="formulario-cbf" src={logo} alt="Logo da cbf" />
            </div>
